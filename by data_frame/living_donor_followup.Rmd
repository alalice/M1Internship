...
```{r}
ld_merge_N <- merge.data.frame(living_donor_followup,ld_N[,c(1,2)],by.x = "id_ind_ld",by.y = "id_ind_ld", all.y = TRUE)
...
```{r}
write.xlsx(dataframe, file = "C:\\Alice\\1-Universitée\\Stages\\M1-centrale\\DATAS\\Describe\\explore\\explore_NA.xlsx",sheetName = "living_donor_followup", append = TRUE)
```
